...
const docTemplate = `{
    ...
    "paths": {
        "/api/v1/approve": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Signed approval JWT",
                        "name": "token",
                        "in": "query",
                        "required": true
                    }
        ...
        "/api/v1/repositories/{id}/setup-security": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Auto-enables GitHub Dependabot, Secret Scanning, and CodeQL for a repository,\nthen immediately runs an AI-powered direct scan of the codebase for instant findings.\nRuns asynchronously — returns 202 immediately and populates findings in the background.",
                "produces": [
                    "application/json"
                ],
                "tags": [
